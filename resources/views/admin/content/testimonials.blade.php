                ...
                <table class="table table-hover align-middle mb-0">
                    <thead class="bg-light">
                        <tr>
                            ...
                            <th class="text-muted small fw-medium text-uppercase border-0">Testimonial</th>
                            <th class="text-muted small fw-medium text-uppercase border-0">Rating</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="border-0">
                                <div class="fw-bold">{{ $testimonial['user'] }}</div>
                            </td>
                            <td class="border-0 small text-muted" style="max-width: 300px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">
                                "{{ $testimonial['text'] }}"
                            </td>
                            <td class="border-0 text-warning">
