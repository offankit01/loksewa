    ...
    <div class="card border-0 shadow-sm rounded-4 bg-white">
        <form action="{{ route('admin.content.blogs.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row g-4">
                    <div class="col-md-8">
                        <div class="mb-3">
                            ...
                            <input type="text" name="title" class="form-control rounded-3" placeholder="Enter post title" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label fw-bold small">Content</label>
                            <textarea name="content" class="form-control rounded-3" rows="15" placeholder="Write your blog content here..." required></textarea>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card bg-light border-0 rounded-4 p-3 mb-4">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="excerpt" class="form-control rounded-3 small" rows="4" placeholder="Brief summary for list view..."></textarea>
                            </div>
                        </div>
                        ...
                        <div class="card bg-light border-0 rounded-4 p-3">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text extra-small mt-2">Recommended: 1200x630px (Max 2MB)</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card-footer bg-white border-0 p-4 pt-0 text-end">
                ...
                <button type="submit" class="btn btn-primary-blue rounded-pill px-5 fw-bold">Save Blog Post</button>
            </div>
        </form>
    </div>
@endsection
