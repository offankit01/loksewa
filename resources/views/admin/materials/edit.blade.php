        ...
        <div class="card border-0 shadow-sm rounded-4 bg-white overflow-hidden">
            ...
            <div class="card-body p-0">
                <form action="{{ route('admin.materials.update', $material->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-4 p-md-5 border-bottom">
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                ...
                                <input type="text" name="title" id="materialTitle" class="form-control form-control-lg rounded-3 bg-light border-0" 
                                       value="{{ old('title', $material->title) }}" placeholder="e.g. Nepal Constitution 2072 Summary" required>
                                <div class="extra-small text-muted mt-1">Slug: <span id="slugPreview" class="text-primary-blue">/{{ $material->slug }}</span></div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div id="selectedCategoryDisplay" class="p-3 border rounded-3 bg-light d-flex justify-content-between align-items-center cursor-pointer hover-shadow transition" data-bs-toggle="modal" data-bs-target="#serviceSelectorModal">
                                    <span class="text-dark fw-bold small" id="selectedCourseName">
                                        {{ $material->course->title ?? 'Select Category...' }}
                                    </span>
                                    <i class="bi bi-chevron-down small"></i>
                                </div>
                                <input type="hidden" name="course_id" id="course_id_input" value="{{ old('course_id', $material->course_id) }}" required>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row g-2">
                                    ...
                                    <div class="col-6">
                                        <input type="radio" class="btn-check" name="type" id="type_{{ $val }}" value="{{ $val }}" {{ $material->type == $val ? 'checked' : '' }}>
                    ...
                    <div class="p-4 p-md-5 bg-light bg-opacity-30 border-bottom">
                        ...
                        <div class="row g-4">
                            <div class="col-12">
                                ...
                                <div class="upload-area p-5 border-dashed rounded-4 text-center bg-white cursor-pointer" id="dropArea">
                                    <div id="uploadPlaceholder" class="{{ $material->file_path ? 'd-none' : '' }}">
                                    ...
                                    <div id="fileSelectedView" class="{{ $material->file_path ? '' : 'd-none' }}">
                                        ...
                                        <h6 class="fw-bold mb-1 text-primary-blue" id="fileNameDisplay">
                                            {{ $material->file_path ? basename($material->file_path) : 'Filename.pdf' }}
                                        </h6>
                                ...
                                <p class="extra-small text-muted mt-2"><i class="bi bi-info-circle me-1"></i> Current file: <span class="text-primary-blue">{{ $material->file_path ? basename($material->file_path) : 'None' }}</span>. Leave empty to keep it.</p>
                            </div>
                            ...
                            <div class="col-12">
                                <div class="p-3 border rounded-4 bg-white shadow-sm d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="form-check form-switch fs-4">
                                        <input class="form-check-input cursor-pointer" type="checkbox" name="is_premium" id="is_premium" value="1" {{ $material->is_premium ? 'checked' : '' }}>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    {{-- Section 3: Finalize --}}
                    <div class="p-4 p-md-5 text-center d-flex gap-3 justify-content-center">
                        <a href="{{ route('admin.materials.index') }}" class="btn btn-light btn-lg px-5 rounded-pill fw-bold">Cancel</a>
                        <button type="submit" class="btn btn-primary-blue btn-lg px-5 rounded-pill fw-bold shadow-lg">
                            <i class="bi bi-check-circle me-2"></i>Update Resource Now
                        </button>
                    </div>
                </form>
            </div>
