...
@section('title', 'About Us - Lok Siksha')
        ...
        <div class="container py-5 position-relative z-1">
            <div class="row align-items-center g-5">
                <div class="col-lg-6">
                    ...
                    <p class="lead text-white-50 mb-0 fs-4">Lok Siksha was founded on a simple belief: that every talented aspirant in Nepal deserves access to world-class preparation tools, regardless of their location.</p>
                </div>
                <div class="col-lg-6">
    ...
    <section class="py-5 bg-white">
        <div class="container py-5">
            <div class="text-center mb-5">
                ...
                <h2 class="display-5 fw-extrabold mb-3">Meet the Minds Behind Lok Siksha</h2>
                        ...
                        <div class="row g-0">
                            <div class="col-md-5 bg-gradient-dark p-5 text-white d-flex flex-column justify-content-center position-relative overflow-hidden">
                                ...
                                <div class="position-relative z-1">
                                    <h2 class="fw-extrabold mb-4 display-6">Share Your Lok Siksha Experience</h2>
        ...
        <div class="container text-center py-5">
            <div class="cta-block-premium p-5 shadow-lg">
                ...
                <div class="position-relative z-1">
                    ...
                    <p class="text-white-50 mb-5 max-w-xl mx-auto fs-5">Join thousands of students who have already started their journey with Lok Siksha. Let's make your dream a reality.</p>
